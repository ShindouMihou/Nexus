package pw.mihou.nexus.core.threadpool;
...
public class NexusThreadPool {
    ...
    public static final ScheduledExecutorService scheduledExecutorService =
            Executors.newScheduledThreadPool(CORE_POOL_SIZE, new ThreadFactory("Nexus.Scheduler: %d", false));
    ...
    public static final ExecutorService executorService = new ThreadPoolExecutor(
            ...
            new ThreadFactory("Nexus.Executor: %d", false));
